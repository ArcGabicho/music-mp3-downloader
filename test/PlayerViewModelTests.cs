...
public class PlayerViewModelTests
{
    ...
    public void Play_sets_current_and_marks_track_playing()
    {
        ...
        var vm = new PlayerViewModel(fake, new ImmediateUiDispatcher(), new FakeWaveformService());
        var tracks = Queue(3);
        vm.SetQueue(tracks);
    ...
    {
        var vm = new PlayerViewModel(new FakeAudioPlayer(), new ImmediateUiDispatcher(), new FakeWaveformService());
        var tracks = Queue(3);
        vm.SetQueue(tracks);
        vm.Play(tracks[0]);
